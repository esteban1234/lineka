      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            ...
            <p class="textpuntos">Somos un despacho multidisciplinar con clara orientación al Cliente.</p>
          </div>
          
        </div>

         <div class="boton">
             <a href="vistas/contacto.php" class="btn btn-danger btn-outline2 btn-lg btn-contacto">CONTACTA A UNO DE NUESTROS ASESORES</a>
         </div>
      </div>
    </div>
      </div>
