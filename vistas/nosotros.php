...
<div class="bannern">
  <div class="fondo2">
    <p class="texton">Obtenga información sobre los valores, las experiencias y los profesionales que integran LINEKA CONSULTORIA INTEGRAL Y SERVICIOS ADMINISTRATIVOS.</p>
    <div class="boton">
      <a  href="contacto.php" class="btn btn-info btn-outline btn-lg btn-contacto">CONTACTANOS</a>
    </div>
  </div>
</div>
        ...
        <div class="row cont-cu">
          ...
          <div class="col-xs-12 col-sm-12 col-md-4">
            ...
            <p class="textpuntos">
              ...
              Flexibilidad: Nos adaptamos a sus necesidades.<br>
              Cercanía: Nos ponemos en su lugar y estamos siempre a su disposición.<br>
              Integridad: Le planteamos las posibles soluciones a su problema con transparencia y honestidad.<br>
              Compromiso: Cumplimos fielmente con nuestras propuestas.<br>
              Éxito: Perseguimos siempre la obtención del mejor resultado.
            </p>
          </div>
         ...
         <div class="boton">
             <a href="contacto.php" class="btn btn-danger btn-outline2 btn-lg btn-contacto">CONTACTA A UNO DE NUESTROS ASESORES</a>
         </div>
      </div>
    </div>
      </div>
