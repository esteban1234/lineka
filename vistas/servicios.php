...
<div class="banners">
  <div class="fondo2">
    <p class="textos">Crecimiento Financiero <br>Acompañamiento Financiero</p>
    <div class="boton">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-6 col-md-6">
            ...
            <p class="subtit-aaa">Cuatro grandes bloque de actividad informan este área: <br><br>
              ...
              Defensa de los intereses del obligado tributario frente a la Admnistración en procedimientos económico administrativos y contencioso administrativos.<br><br>
          ...
          <div class="col-sm-6 col-md-6">
            ...
            <p class="subtit-aaa">Te ofrecemos el apoyo legal que necesitas y garantizamos tu negocio: <br><br>
              ...
              Contratación informática y propiedad intelectual sitios web.</p>
            <p></p>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-sm-6 col-md-6">
            ...
            Derecho energético<br><br>
            Empresa familiar<br><br>
</p>
            <p></p>
          </div>
          <div class="col-sm-6 col-md-6">
            ...
            <p class="subtit-aa">Te ofrecemos el apoyo legal que necesitas en negociación y mediación: <br><br>
              ...
              Evitamos la vía judicial, contenciosa. <br><br>
              MEDIACIÓN<br><br>
              Redacción de acuerdos de mediación. <br><br>
              Intervención como mediadores. <br><br>
              Asesoramiento a mediadores. <br><br>
</p>
            <p></p>
          </div>
        </div>
